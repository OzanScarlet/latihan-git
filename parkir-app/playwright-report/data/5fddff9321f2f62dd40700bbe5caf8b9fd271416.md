...
- Name: checkin.spec.ts >> Check-in Flow (Petugas) >> check-in motor tanpa slot berhasil
- Location: e2e\checkin.spec.ts:23:7
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    6 × locator resolved to <html lang="id">…</html>
      - unexpected value "http://localhost:3000/login"
    7 × locator resolved to <html lang="id">…</html>
