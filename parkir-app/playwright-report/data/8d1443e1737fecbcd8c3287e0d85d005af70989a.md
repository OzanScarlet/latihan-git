...
- Name: admin-petugas.spec.ts >> Admin Petugas Management >> reset password akun petugas
- Location: e2e\admin-petugas.spec.ts:39:7

# Error details

```
Error: locator.click: Error: strict mode violation: locator('text=joko@parkir.id').locator('xpath=ancestor::div[contains(@class,\'flex\')]').locator('summary').filter({ hasText: 'reset' }) resolved to 4 elements:
    1) <summary class="cursor-pointer text-xs text-blue-600 hover:underline select-none">reset</summary> aka getByText('reset').first()
    2) <summary class="cursor-pointer text-xs text-blue-600 hover:underline select-none">reset</summary> aka getByText('reset').nth(1)
    3) <summary class="cursor-pointer text-xs text-blue-600 hover:underline select-none">reset</summary> aka getByText('reset').nth(2)
    4) <summary class="cursor-pointer text-xs text-blue-600 hover:underline select-none">reset</summary> aka getByText('reset').nth(3)

Call log:
  - waiting for locator('text=joko@parkir.id').locator('xpath=ancestor::div[contains(@class,\'flex\')]').locator('summary').filter({ hasText: 'reset' })
  ...
  - generic [ref=e3]:
    ...
    - main [ref=e15]:
      - generic [ref=e16]:
        ...
        - generic [ref=e36]:
          - heading "Daftar Akun (4)" [level=3] [ref=e38]
          - generic [ref=e40]:
            - generic [ref=e41]:
              - generic [ref=e42]:
            ...
            - generic [ref=e63]:
              - generic [ref=e64]:
                - generic [ref=e65]: Petugas Test
                - generic [ref=e66]: testuser-1785404112843@parkir.id
              - generic [ref=e67]:
                - generic [ref=e68]: petugas
                - generic [ref=e69]: aktif
                - button "nonaktifkan" [ref=e71] [cursor=pointer]
                - group [ref=e72]:
                  - generic "reset" [ref=e73] [cursor=pointer]
            - generic [ref=e74]:
              - generic [ref=e75]:
                - generic [ref=e76]: Petugas Test
                - generic [ref=e77]: testuser-1785404202454@parkir.id
              - generic [ref=e78]:
                - generic [ref=e79]: petugas
                - generic [ref=e80]: aktif
                - button "nonaktifkan" [ref=e82] [cursor=pointer]
                - group [ref=e83]:
                  - generic "reset" [ref=e84] [cursor=pointer]
```
