...
```
Error: locator.click: Error: strict mode violation: locator('text=joko@parkir.id').locator('xpath=ancestor::div[contains(@class,\'flex\')]').locator('summary').filter({ hasText: 'reset' }) resolved to 3 elements:
  ...
  - generic [ref=e3]:
    ...
    - main [ref=e15]:
      - generic [ref=e16]:
        ...
        - generic [ref=e36]:
          - heading "Daftar Akun (3)" [level=3] [ref=e38]
          - generic [ref=e40]:
            - generic [ref=e41]:
              - generic [ref=e42]:
